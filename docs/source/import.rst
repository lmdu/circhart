...
The genome synteny analysis results can be used to prepare link data. Circhart supports the import of result files generated by `Blast <https://blast.ncbi.nlm.nih.gov/Blast.cgi>`_, `MUMmer <https://mummer4.github.io/>`_, `JCVI <https://github.com/tanghaibao/jcvi>`_ and `MCScanX <https://github.com/wyp1125/MCScanX>`_.


Import Blast Alignment File
^^^^^^^^^^^^^^^^^^^^^^^^^^^

Circhart can parse whole-genome alignment file generated by Blast with parameter ``-outfmt 6``. The example command for running Blast:

.. code::

	blastn -query genome1.fasta -subject genome2.fasta -evalue 1e-10 -outfmt 6 -out alignment.txt

The alignment file looks like this:

.. code::

	EMA01G00123.1	EMA01G00123.1	100.000	111	0	0	1	111	1	111	1.20e-52	160
	EMA01G03107.1	EMA01G03107.1	100.000	104	0	0	1	104	1	104	1.04e-71	207
	EMA01G02470.1	EMA01G02470.1	100.000	173	0	0	1	173	1	173	1.01e-128	357
	EMA01G02470.1	EMA07G00388.1	92.547	161	12	0	1	161	1	161	1.11e-100	290
	EMA01G02364.1	EMA01G02364.1	100.000	376	0	0	1	376	1	376	0.0	779
	EMA01G02618.1	EMA01G02618.1	100.000	398	0	0	1	398	1	398	0.0	816
	EMA01G02618.1	EMA04G00947.1	37.559	213	103	6	14	223	82	267	6.00e-34	132
...
Import MUMmer Coords File
^^^^^^^^^^^^^^^^^^^^^^^^^

Circhart can parse whole-genome alignment coords file generated by MUMmer. The example command for running MUMmer:

.. code::

	nucmer -p output reference.fasta query.fasta
	show-coords -lHT output.delta > output.coords

The coord file looks like this:

.. code::

	1	210	3644	3848	210	205	88.26	4094	24388310	JANHFT010338110.1	Chr12
	1	210	275	475	210	201	88.15	4094	24388310	JANHFT010338110.1	Chr12
	1	239	1331	1578	239	248	85.77	4094	24388310	JANHFT010338110.1	Chr12
	1	210	10387	10603	210	217	87.73	4094	24388310	JANHFT010338110.1	Chr12
	1	221	11949	12177	221	229	87.93	4094	24388310	JANHFT010338110.1	Chr12
	1	227	22312	22546	227	235	87.03	4094	24388310	JANHFT010338110.1	Chr12
	1	239	7383	7630	239	248	85.26	4094	24388310	JANHFT010338110.1	Chr12
...
Import JCVI Simple File
^^^^^^^^^^^^^^^^^^^^^^^

The ``.simple`` file can be generated by JCVI following the `manual <https://github.com/tanghaibao/jcvi/wiki/MCscan-(Python-version)>`_.

The simple file looks like this:
...
Import MCScanX Collinearity File
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

The collinearity file is the result of synteny analysis generally generated by MCScanX following the `protocol <https://www.nature.com/articles/s41596-024-00968-2>`_.

The collinearity file looks like this:
...
.. figure:: _static/collinearity.png
	...
	View of imported collinearity data
